  ...
  return (
    <div>
      <div className="text-gray-600">
        ...
        Stay informed with our weekly newsletter filled with exciting updates and exclusive offers!
        </p>
      </div>
        ...
        <div className="w-full relative flex items-center justify-center">
          ...
          <div className="bg-gray-800 bg-opacity-80 md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
            ...
            <div className="sm:border border-white flex-col sm:flex-row flex items-center lg:w-5/12 w-full mt-12 space-y-4 sm:space-y-0">
              ...
              />
              <button className="focus:outline-none focus:ring-offset-2 focus:ring border  sm:border-transparent w-full sm:w-auto bg-second py-4 px-6 hover:bg-opacity-75 text-white border-none">
                Subscribe
              </button>
            </div>
          </div>
