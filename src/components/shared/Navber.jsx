    ...
    <div className="navbar  bg-first section-container">
      ...
      <div className="navbar-end text-white">
        ...
        {user ? (
            ...
            >
              ...
              <li>
                <button
                  ...
                  className="btn btn-sm whitespace-nowrap text-black  btn-ghost"
                >
                  Logout
                </button>
              </li>
          ...
          <Link to="/login">
            <button className="btn btn-sm bg-second text-white outline-none border-0 hover:text-second hover:bg-white ">Login</button>
          </Link>
        )}
      </div>
    </div>
